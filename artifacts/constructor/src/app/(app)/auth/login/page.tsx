...
const GOOGLE_ERRORS: Record<string, string> = {
  ...
  google_token: "Не удалось получить токен от Google.",
  google_no_email: "Google не предоставил email.",
  google_user: "Ошибка создания пользователя.",
  google_server: "Ошибка сервера при Google-авторизации.",
};
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="hidden w-1/2 flex-col justify-between bg-gradient-to-br from-brand-600 to-brand-900 p-12 text-white lg:flex">
        ...
        <p className="text-sm text-brand-200">XEMENS © 2026</p>
      </div>
      ...
      <div className="flex w-full flex-col justify-center px-8 lg:w-1/2">
        <div className="mx-auto w-full max-w-md">
          ...
          <div className="my-6 flex items-center gap-4">
            ...
            <span className="text-sm text-[var(--muted)]">или войти по email</span>
            <div className="h-px flex-1 bg-[var(--border)]" />
          </div>
