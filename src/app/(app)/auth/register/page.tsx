      ...
      <div className="flex w-full flex-col justify-center px-8 lg:w-1/2">
        <div className="mx-auto w-full max-w-md">
          ...
          <button
            ...
            className="mt-6 flex w-full items-center justify-center gap-3 rounded-xl border border-[var(--border)] bg-[var(--card)] py-3 font-medium hover:bg-black/5"
          >
            ...
            Войти через Google (XEMENS)
          </button>
          <p className="mt-2 text-center text-[10px] text-[var(--muted)]">
            Google сразу создаёт аккаунт. Email — с кодом на почту, затем отдельный вход.
          </p>
